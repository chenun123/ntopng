...
if(page == "overview") then
  ...
  print[[
      ...
      <div class='row'>
        <div class="col-md-12">
          <div id="am-alert" class="alert alert-success" style="display: none" role="alert">
            <strong>]] print(i18n("success")) print[[</strong> <span class="alert-body"></span>
      ...
      <div class='row'>
        <div class='col-md-12 col-12'>
          <table class="table w-100 table-striped table-hover table-bordered" id="am-table">
            <thead>
              <tr>
                <th>]] print(i18n("flow_details.url")) print[[</th>
                <th>]] print(i18n("chart")) print[[</th>
                <th>]] print(i18n("threshold")) print[[</th>
                <th>]] print(i18n("active_monitoring_stats.last_measurement")) print[[</th>
                <th>]] print(i18n("system_stats.last_ip")) print[[</th>
                <th>]] print(i18n("active_monitoring_stats.measurement")) print[[</th>
                <th>]] print(i18n("actions")) print[[</th>
              </tr>
            </thead>
            <tbody>
            </tbody>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">]] print(i18n("active_monitoring_stats.edit_record")) print[[</h5>
            ...
            <div class="modal-body container-fluid">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">]]  print(i18n("active_monitoring_stats.measurement")) print[[</label>
                <div class="col-sm-5">
                  ]] print(generate_select("select-edit-measurement", "measurement", true, false, {}, "measurement-select")) print[[
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">]] print(i18n("about.host_callbacks_directory")) print[[</label>
                <div class="col-sm-5">
                  <input placeholder="yourhostname.org" required id="input-edit-host" type="text" name="host" class="form-control measurement-host" />
                </div>
              </div>
	      <div class="form-group row">
                <label class="col-sm-3 col-form-label">]] print(i18n("internals.periodicity")) print[[</label>
                <div class="col-sm-5">
                  ]] print(generate_select("select-edit-granularity", "granularity", true, false, {}, "measurement-granularity")) print[[
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">]] print(i18n("threshold")) print[[</label>
                <div class="col-sm-5">
              ...
              <ul>
                <li>]] print(i18n("active_monitoring_stats.am_note_icmp")) print[[</li>
                <li>]] print(i18n("active_monitoring_stats.am_note_http")) print[[</li>
                <li>]] print(i18n("active_monitoring_stats.note_alert")) print[[</li>
		<li>]] print(i18n("active_monitoring_stats.note_periodicity_change")) print[[</li>
              </ul>
              </div>
              <span class="invalid-feedback"></span>
            </div>
            <div class="modal-footer">
              <button id="btn-reset-defaults" type="button" class="btn btn-danger mr-auto">]] print(i18n("reset")) print[[</button>
              <button type="button" class="btn btn-secondary" data-dismiss="modal">]] print(i18n("cancel")) print[[</button>
              <button type="submit" class="btn btn-primary">]] print(i18n("apply")) print[[</button>
            </div>
          </div>
        </div>
      </form>
    ...
    <div id='am-add-modal' class="modal fade" tabindex="-1" role="dialog">
      <form method="post" id='am-add-form'>
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">]] print(i18n("active_monitoring_stats.add_record")) print[[</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body container-fluid">
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">]] print(i18n("active_monitoring_stats.measurement")) print[[</label>
                <div class="col-sm-5">
                  ]] print(generate_select("select-add-measurement", "measurement", true, false, {}, "measurement-select")) print[[
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">]] print(i18n("about.host_callbacks_directory")) print[[</label>
	      ...
	      <div class="form-group row">
                <label class="col-sm-3 col-form-label">]] print(i18n("internals.periodicity")) print[[</label>
                <div class="col-sm-5">
                  ]] print(generate_select("select-add-granularity", "granularity", true, false, {}, "measurement-granularity")) print[[
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-3 col-form-label">]] print(i18n("threshold")) print[[</label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">]]  print(i18n("cancel")) print[[</button>
              <button type="submit" class="btn btn-primary">]]  print(i18n("add")) print[[</button>
            </div>
          </div>
        </div>
      </form>
    ...
    <div id='am-delete-modal' class="modal fade" tabindex="-1" role="dialog">
      <form id='am-delete-form'>
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">]]  print(i18n("delete")) print[[: <span id="delete-host"></span></h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <p>
		              ]]  print(i18n("active_monitoring_stats.confirm_delete")) print[[
              </p>
              <span class="invalid-feedback"></span>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">]]  print(i18n("cancel")) print[[</button>
              <button id="btn-delete-am" type="submit" class="btn btn-danger">]]  print(i18n("delete")) print[[</button>
            </div>
          </div>
        </div>
      </form>
    ...
    <div style="margin-bottom: 1rem">
        <form action="]] print(ntop.getHttpPrefix()) print[[/plugins/get_active_monitoring_config.lua" class="form-inline" method="GET">
            <button type="submit" class="btn btn-secondary"><span>]]  print(i18n('config_scripts.config_export')) print[[</span></button>
        </form><button id="import-modal-btn" data-toggle="modal" data-target="#import-modal" class="btn btn-secondary"><span>]]  print(i18n('config_scripts.config_import')) print[[</span></button>
	<form class="form-inline" method="POST" id="reset-form">
	  <input type="hidden" name="csrf" value="]] print(ntop.getRandomCSRFValue()) print[["/>
	  <input type="hidden" name="action" value="reset_config"/>
	  <button type="button" id="reset-modal-btn" data-toggle="modal" data-target="#reset-modal" class="btn btn-secondary"><span>]]  print(i18n('config_scripts.config_reset')) print[[</span></button>
	</form>
    </div>

    <div>
      ]] print(i18n("notes")) print[[<ul>
	<li>]] print(i18n("active_monitoring_stats.note3", {product=info.product})) print[[</li>
	<li>]] print(i18n("active_monitoring_stats.note_alert")) print[[</li>
      </ul>
    </div>
  ]]
